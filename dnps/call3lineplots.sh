...
#
# Summary:
# This script generates and submits SLURM jobs to create three-line averaged
# nucleosome positioning profile plots. Similar to makeavgplotscripts.sh, but
# calls a different plotting script (make3lineplots.py) that may have
# alternative visualization options or formatting.
#
# The script organizes transcription factors by their profile categories
# (DIP/DIP, DIP/PEAK, PEAK/DIP, PEAK, AMBIGUOUS) and creates averaged plots
# for each category.
#
# Prerequisites:
...
#   - make3lineplots.py script
#
# Output:
#   - Averaged three-line profile plots per cell line and profile category
# =============================================================================
...
JOB_SCRIPTS_DIR="${SCRIPTS_DIR}/plot_job_scripts/3lineplots"
TF_LISTS_DIR="${SCRIPTS_DIR}/plot_job_scripts/avgs/tf_lists"
...
# Array of cell lines
CELL_LINES=("MCF-7" "HeLa" "HCT116" "MCF-7" "HepG2" "H1_hESC")
...
# Run the three-line plotting script
python SCRIPTS_DIR/make3lineplots.py \
    "TF_LIST_FILE" \
    "OUTPUT_PNG" \
    "CELL_LINE" \
    "PROFILE"
